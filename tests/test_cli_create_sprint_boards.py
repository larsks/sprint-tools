...
def test_create_sprint_boards(api, runner):
    ...
    expected_title = 'Sprint week 5 and 7 2021'
    expected_body = '{"week1": "2021-02-01", "week2": "2021-02-15"}'
...
def test_create_sprint_boards_with_create_issue(api, runner):
    ...
    expected_issue_title = 'Sprint notes for week 5 and 7 2021'
...
def test_create_sprint_boards_with_existing_issue(api, runner):
    ...
    mock_repo.get_issues.return_value = [
        mock.Mock(
            title='Sprint notes for week 5 and 7 2021',
            number=1,
